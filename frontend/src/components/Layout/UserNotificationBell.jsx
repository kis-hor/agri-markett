...
const UserNotificationBell = () => {
  ...
  const getIcon = (type) => {
    switch (type) {
      ...
      case "new_order":
        return <MdOutlineShoppingCart className="text-blue-500" size={20} />
      case "promotion":
      ...
      case "shop_update":
        return <MdOutlineStore className="text-indigo-500" size={20} />
      default:
  ...
  return (
    <div className="relative" ref={notificationRef}>
      ...
      >
        <IoMdNotificationsOutline size={22} color="rgb(255 255 255 / 83%)" />
        {unreadCount > 0 && (
