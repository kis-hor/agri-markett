  ...
  const handlePaymentSubmit = async () => {
    ...
    if (selectedPaymentMethod === "esewa") {
      ...
      try {
        ...
        const response = await axios.post(`${server}/order/create-order`, orderData)
          ...
          <div className="w-full 800px:w-[65%]">
            <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
              ...
              <div className="w-full flex flex-col mt-4">
                ...
                <div 
                  className={`w-full flex items-center justify-between p-4 border rounded-md mb-4 cursor-pointer ${
                    selectedPaymentMethod === "esewa" ? "border-[#60BB46]" : ""
                  }`}
                ...
                >
                  <div className="flex items-center">
                    <input 
                      ...
                      onChange={() => handlePaymentMethodSelect("esewa")}
                      className="mr-2" 
                    />
                ...
                <div 
                  className={`w-full flex items-center justify-between p-4 border rounded-md mb-4 cursor-pointer ${
                    selectedPaymentMethod === "cod" ? "border-gray-800" : ""
                  }`}
                ...
                >
                  ...
                  <FaMoneyBillWave className="text-gray-700 text-2xl" />
                </div>
              </div>
            </div>
          </div>
          <div className="w-full 800px:w-[35%] 800px:mt-0 mt-8">
            ...
            >
              <h5 className="text-white">
                {selectedPaymentMethod === "esewa" ? "Pay with eSewa" : "Place Order (COD)"}
              </h5>
            </div>
          </div>
        </div>
