      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="w-full bg-white rounded-md shadow-md p-4 relative overflow-hidden hover:shadow-lg transition-shadow">
          <div className="flex w-full pb-3 border-b mb-2 items-center">
            ...
            <div className="absolute right-4 top-4 bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">
              Available
            </div>
          </div>
          ...
          {select === 2 && (
            <div className="w-full mt-4">
              ...
              <form className="w-full" onSubmit={cashOnDeliveryHandler}>
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-gray-800 hover:bg-gray-900 text-white rounded-md font-medium flex items-center justify-center"
                >
